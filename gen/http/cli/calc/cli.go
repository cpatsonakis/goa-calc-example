...
import (
	...
	calcc "github.com/cpatsonakis/goa-calc-example/gen/http/calc/client"
...
func ParseEndpoint(
	...
	var (
		...
		calcMultiplyAFlag = calcMultiplyFlags.String("a", "REQUIRED", "First operand of multiplication payload")
		calcMultiplyBFlag = calcMultiplyFlags.String("b", "REQUIRED", "Second operand of multiplication payload")
	)
...
Multiply two integers a and b and get the result in the response's body.
    -a INT: First operand of multiplication payload
    -b INT: Second operand of multiplication payload
